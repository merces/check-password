...
check-password is ppolicy module used to enforce strong password checks in OpenLDAP

## Compiling

1. Download the appropriate source code package for your system from the [OpenLDAP website](https://www.openldap.org).
